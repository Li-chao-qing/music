window.onload=function(){
	...
	audio.onvolumechange=function(){
		// dian.style.left=this.volume*100+'%';
		if(audio.volume==0){
			// console.log(1);
			jingyin.setAttribute('class','icon icon1');
		}else{jingyin.setAttribute('class','icon');}
		dian.style.left=this.volume*100-dian.offsetWidth/2+'%';
	...
	dian.onmousedown=function(){
		document.onmousemove=function(e){
			...
			var aa=(e.clientX-voice_jindu.getBoundingClientRect().left);
			aa=aa>=0?aa:0;
			aa=aa>=voice_jindu.offsetWidth?voice_jindu.offsetWidth:aa;
			audio.volume=aa/voice_jindu.offsetWidth;
			// 
		}
	};
